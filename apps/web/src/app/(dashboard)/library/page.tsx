...
export default function LibraryPage() {
  ...
  const handleSave = async () => {
    ...
    const { data, error } = await saveLibraryItem(user.id, nextItem);
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-zinc-400">Aún no hay elementos guardados. Crea uno arriba para empezar.</p>
      ) : (
